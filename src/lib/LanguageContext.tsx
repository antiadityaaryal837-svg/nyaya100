...
export const translations = {
  ...
  ne: {
    nav: {
      ...
      adminPanel: 'प्रशासक',
      profile: 'प्रोफाइल',
      assistant: 'एआई कानुनी सहायक',
      report: 'घटना रिपोर्ट गर्नुहोस्',
      cases: 'मुद्दा ट्र्याकिङ',
      community: 'समुदाय फिड',
      lawyers: 'प्रमाणित वकिलहरू',
      adminOverview: 'प्रशासक सिंहावलोकन',
      caseReview: 'मुद्दा समीक्षा',
      manageLawyers: 'वकिल व्यवस्थापन',
      manageFeed: 'फिड व्यवस्थापन',
    },
    hero: {
